...
Animals.prototype.speech = function(){
  ...
  if(this.soul === 1) return this.chat.message(this.nickname, `Hi, my nickname is ${this.nickname}! I'm a ${this.color} ${this.species}. I'm ${this.age} years old. I have a soul!`)
  else return this.chat.message(this.nickname, ` Hi, my nickname is ${this.nickname}! I was a ${this.color} ${this.species}. I was ${this.age} years old. I don't have a soul anymore. :(`)
}

Animals.prototype.speak = function(){
  return this.chat.message(this.nickname, `${this.sound}`)
}
...
Animals.prototype.say = function(msg){
  return this.chat.message(this.nickname, `${msg}`)
}
